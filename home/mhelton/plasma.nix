{ inputs, pkgs, ... }: {
  ...
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Expose" = "Ctrl+F9";
      "kwin"."ExposeAll" = [ "Ctrl+F10" "Ctrl+Alt+Tab" ];
      ...
      "org.kde.spectacle.desktop"."RectangularRegionScreenShot" = [ "Meta+Shift+Print" "Meta+$" ];
    ...
    configFile = {
      ...
      "kactivitymanagerdrc"."activities"."8d0d13b8-1f4a-403b-bc55-5d80fb89abec" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "8d0d13b8-1f4a-403b-bc55-5d80fb89abec";
      "kcminputrc"."Libinput.1133.16440.Logitech Wireless Mouse PID:4038"."Enabled" = true;
      "kcminputrc"."Libinput.1133.16478.Logitech M720 Triathlon"."NaturalScroll" = true;
      "kcminputrc"."Libinput.1133.16478.Logitech M720 Triathlon"."PointerAcceleration" = 0.200;
      "kcminputrc"."Libinput.1133.16478.Logitech M720 Triathlon"."PointerAccelerationProfile" = 2;
      "kcminputrc"."Libinput.1133.16478.Logitech Wireless Device PID:405e"."NaturalScroll" = true;
      "kcminputrc"."Libinput.1452.591.Keychron Keychron K3"."NaturalScroll" = false;
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "1740,780";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{2b632dba-bc65-4e00-8dcb-c5749f722d54}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{35afab16-4021-40b8-ba74-04148b70b0ba}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{b04e6167-f97b-4b82-babb-23a099a372d0}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{5a81552c-b0d4-4b78-bee9-243b9804521a}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{05e9c3f0-b430-4bf3-a059-a23ae86fb20d}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{2a4a7fa5-d217-4c10-8df3-6b06e22c1ddd}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{2bfcae3a-5845-42fb-a79e-c24f280dfa38}";
      ...
      "klaunchrc"."TaskbarButtonSettings"."Timeout" = 1;
      ...
      "kwinrc"."Tiling.246c23d5-94bf-5bb5-b009-84e3262d248e"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.67132d5a-edc9-5dc7-9d81-f9898ab351e2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.9350f969-92d0-5658-bb27-639b07d90acc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
